...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__manager__ = __webpack_require__(10);
...
class Hotkeys extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
	...
	componentWillMount() {
		__WEBPACK_IMPORTED_MODULE_2__manager__["a" /* default */].bindKeys(this.keys, this.handleHotkey);
	}

	componentWillUnmount() {
		__WEBPACK_IMPORTED_MODULE_2__manager__["a" /* default */].unbindKeys(this.keys, this.handleHotkey);
	}
...
Hotkeys.propTypes = {
	keys: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.oneOfType([__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string, __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string)]).isRequired,
	callback: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func.isRequired,
	disabled: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.oneOfType([__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func, __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool])
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mousetrap__ = __webpack_require__(11);
...
const reject = (list, test) => list.reduce((memo, item, index) => test(item, index) ? memo : (memo.push(item), memo), []);

const noop = () => {};

class Manager {
	constructor(element = document.body) {
		this.manager = __WEBPACK_IMPORTED_MODULE_0_mousetrap___default()(element);
		this.keys = new Map();
	}
